...
* 입출력 예
food	        result
[1, 3, 4, 6]	"1223330333221"  //나눈 뒤에 양측에 하나씩 배치하는 것이다. 짝수가 아닌경우 없는것으로 취급
[1, 7, 1, 2]	"111303111"

* 풀이
* food 배열의 첫 인덱스 0은 물을 의미, 1은 3개 2는 4개 3은 6개의 음식을 말한다
* 음식 개수가 짝수개가 있어야 서로 먹을 수 있으므로, 음식의 수를 2로 나눈 몫 만큼만 String에 붙인다.
* 그 다음 나온결괄르 0과 함게 거꾸로 붙이면 된다.
