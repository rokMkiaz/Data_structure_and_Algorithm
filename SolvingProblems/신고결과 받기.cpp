...
다음은 전체 유저 목록이 ["muzi", "frodo", "apeach", "neo"]이고, k = 2(즉, 2번 이상 신고당하면 이용 정지)
인 경우의 예시입니다.
...
vector<int> solution(vector<string> id_list, vector<string> report, int k) {
    map<string, set<string>> calleeTable; //key인 string은 신고 당한 사람, set은 그 사람을 신고한 사람의 집합
    map<string, set<string>> callerTable; //key인 string은 신고 한 사람, set은 그 사람이 신고한 사람의 집합
